import { defaultTopicLineForArea } from "@/lib/debate/solo-area-topic-pools";
import type {
  DebateResult,
  DebateSession,
  TopicCategory,
...
export const mockTopics: TopicCategory[] = [
  {
    id: "class-forge",
    title: "CLASS FORGE",
    description: defaultTopicLineForArea("class-forge"),
  ...
  },
  {
    id: "home-base",
    title: "HOME BASE",
    description: defaultTopicLineForArea("home-base"),
    badge: "YOUNG ARCHITECTS",
    icon: "groups",
    accent: "tertiary",
  },
  {
    id: "arcade-arena",
    title: "ARCADE ARENA",
    description: defaultTopicLineForArea("arcade-arena"),
    badge: "POP CULTURE",
    icon: "rocket_launch",
    accent: "tertiary",
  },
  {
    id: "biomes-beasts",
    title: "BIOMES & BEASTS",
    description: defaultTopicLineForArea("biomes-beasts"),
    badge: "YOUNG ARCHITECTS",
    icon: "pets",
    accent: "tertiary",
  },
  {
    id: "redstone-lab",
    title: "REDSTONE LAB",
    description: defaultTopicLineForArea("redstone-lab"),
  ...
  },
  {
    id: "village-hall",
    title: "VILLAGE HALL",
    description: defaultTopicLineForArea("village-hall"),
    badge: "MASTER BUILDERS",
    icon: "eco",
    accent: "tertiary",
  },
